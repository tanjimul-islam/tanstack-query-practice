...
const ProductDetails = ({ id }) => {
  ...
  return product ? (
    <div className="h-screen flex items-center justify-center p-10">
      <div className="w-full max-w-3xl px-6 overflow-hidden p-10">
        <div className="flex flex-col md:flex-row gap-16 mt-4">
          ...
          <div className="text-sm w-full md:w-1/2">
            ...
            <div className="mt-6">
              ...
              <p className="text-gray-500/70">STOCK: {product.stock}</p>{" "}
              <p className="text-gray-500/70">BRAND: {product.brand}</p>
            </div>
    ...
    <h1 className="text-4xl h-screen flex items-center justify-center p-10 text-red-400 underline font-semibold ">
      Click on any product to show details
    </h1>
  );
};
